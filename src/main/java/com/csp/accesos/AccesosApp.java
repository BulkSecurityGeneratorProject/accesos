package com.csp.accesos;

import com.csp.accesos.config.Constants;
import com.csp.accesos.config.JHipsterProperties;
...
public class AccesosApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(AccesosApp.class);
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AccesosApp.class);
